...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        .setDescription('❌ O ticket será encerrado em **10 Segundos**, Obrigado!')
        .setColor('#ff0000')
        ...
        const embed = new discord.EmbedBuilder()
            ...
            .setDescription(`**Projeto do <@${interaction.user.id}> foi finalizado! \n⠀**`)
            .addFields({name: 'TIPO:', value: `**${ticketOption}**`})
            .setThumbnail('https://cdn.discordapp.com/attachments/894718530736496671/1113093131919962252/giphy_2.gif')
